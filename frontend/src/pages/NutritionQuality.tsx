...
const NutritionQuality = () => (
  <Layout>
    <section 
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=1600&q=80')"
      }}
    >
      <div className="container mx-auto px-4 text-center relative z-10">
        <AnimatedSection>
          <h1 className="text-5xl md:text-6xl font-heading font-bold text-white mb-6">Nutrition & Quality</h1>
          <p className="text-white text-xl max-w-2xl mx-auto mb-8">Our commitment to excellence in every meal we prepare and deliver.</p>
        </AnimatedSection>
      </div>
    </section>
