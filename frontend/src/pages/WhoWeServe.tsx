...
const WhoWeServe = () => (
  <Layout>
    ...
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=1600&q=80')",
      }}
    >
      <div className="container mx-auto px-4 text-center relative z-10">
        <AnimatedSection>
          ...
          <p className="text-primary-foreground/80 text-xl max-w-2xl mx-auto">
            From hospitals to homes, we deliver meals that nourish and care.
          </p>
        </AnimatedSection>
      </div>
    </section>
    ...
    {sections.map((s, i) => (
      <section
        key={s.title}
        id={s.id}
        className={`py-16 ${i % 2 === 1 ? "bg-surface-light" : ""}`}
      >
          ...
          >
            ...
            >
              <img
                src={s.image}
                alt={s.title}
                className="rounded-lg shadow-md w-full h-72 md:h-96 object-cover"
              />
            </AnimatedSection>
            <AnimatedSection
