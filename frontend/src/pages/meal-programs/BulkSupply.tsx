    ...
    <Layout>
      ...
      <section className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 max-w-screen-xl mx-auto">
          <AnimatedSection>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-primary-foreground max-w-4xl leading-tight mx-auto">
              Bulk Meal Supply (Hospitals & Facilities)
            </h1>
            <p className="text-primary-foreground/80 text-lg md:text-xl mt-4 max-w-2xl mx-auto">
