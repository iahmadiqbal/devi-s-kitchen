...
const navLinks = [
  { label: "Home", path: "/" },
  {
    ...
    dropdown: [
      ...
      {
        label: "Senior Living & Old Age Homes",
        path: "/services/senior-living",
      },
      { label: "NGOs & Community Organizations", path: "/services/ngos" },
      {
        label: "Individual Meal Services (Tiffin for Seniors)",
  ...
  },
  {
    ...
    dropdown: [
      {
        label: "Bulk Meal Supply (Hospitals & Facilities)",
        path: "/meal-programs/bulk-supply",
      },
      ...
      {
        label: "Special Dietary Meals (Low Sodium, Diabetic, etc.)",
        path: "/meal-programs/special-dietary",
      },
    ],
  },
    ...
    >
      ...
      <div className="w-full px-3 sm:px-4 lg:px-20 max-w-[1400px] mx-auto">
        <div className="flex items-center justify-between h-20 lg:h-24 gap-2 sm:gap-4">
          ...
          <Link
            to="/"
            className="flex items-center flex-shrink-0 ml-0 lg:ml-3 mt-2 lg:mt-10"
          >
            <img
              src="/logo.png"
              alt="Devi's Kitchen"
              width="120"
              height="72"
              className="h-[75px] w-[125px] sm:h-[80px] sm:w-[135px] lg:h-[125px] lg:w-[210px] rounded-lg"
              loading="eager"
            />
          </Link>

          {/* Right Actions */}
          <div className="flex items-center gap-1.5 sm:gap-2 mr-0 lg:mr-32 mt-3">
            <a
        ...
        <div className="border-b border-foreground/20 ml-0 lg:ml-[340px] mr-0 lg:mr-[140px] mt-2"></div>
        <div className="border-b border-foreground/20 ml-0 lg:ml-[340px] mr-0 lg:mr-[140px] mt-0"></div>
      </div>
      ...
      <div className="hidden lg:block bg-white">
        <div className="w-full px-6 lg:px-20 max-w-[1400px] mx-auto">
          <div className="ml-0 lg:ml-6 mr-0 lg:mr-32">
            <nav className="flex items-center justify-start gap-1 ml-64 mt-0">
              {navLinks.map((link) => (
                <div
                  key={link.path}
                  className="relative"
